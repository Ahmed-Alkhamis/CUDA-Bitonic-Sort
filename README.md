...
Overview
Bitonic sort is a comparison-based sorting algorithm that focuses on converting a random sequence of numbers into a bitonic sequence (one that monotonically increases then decreases), which is then merged to produce a sorted sequence.
